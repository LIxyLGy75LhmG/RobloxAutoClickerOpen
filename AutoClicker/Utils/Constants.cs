...
namespace AutoClicker.Utils
{
    ...
    {
        public const string MAIN_WINDOW_TITLE_DEFAULT = "Roblox AutoClicker Open  v1.1";
        ...
        public const string SYSTEM_TRAY_MENU_SHOW = "Show Roblox AutoClicker Open";
        public const string SYSTEM_TRAY_MENU_EXIT = "Exit";

        public const string RESOURCES_DIRECTORY = "Resources";
        public const string RUNNING_ICON_RESOURCE_PATH = "Resources/Icons/icon_running.ico";
        ...
        // Hold the button down this long (ms) between DOWN and UP so games (Roblox) actually
        // register the click — an instant down+up happens between game frames and gets ignored.
        public const int CLICK_HOLD_MS = 25;
        public const int DOUBLE_CLICK_GAP_MS = 60;
